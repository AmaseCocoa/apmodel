...
class AS2Model(BaseModel):
    ...
    def dump(self, *args, **kwargs) -> dict:
        ...
        full_result = self.model_dump(by_alias=True)
        ...
        def collect_all_nested_contexts(obj_dict):
        ...
        def remove_all_nested_context(obj_dict, is_root=False):
            if isinstance(obj_dict, dict):
...
def to_dict(model: AS2Model, *args, **kwargs) -> dict:
