# Ported from apkit (original author: @jze (github))

from dataclasses import FrozenInstanceError

import pytest

from apmodel.webfinger import Link, Resource, Result
...
class TestResult:
    ...
    def test_webfinger_result_get_multiple_links(self):
        ...
        links: list[Link] = [
            Link(rel="profile", type="text/html", href="https://example.com/alice"),
            Link(rel="alternate", type="text/html", href="https://example.com/alt/alice"),
            Link(
                rel="self",
                type="application/activity+json",
                href="https://example.com/users/alice",
    ...
    def test_webfinger_result_immutability(self):
        ...
        subject = Resource(username="alice", host="example.com", url=None)
        links = [Link(rel="profile", type="text/html", href="https://example.com/alice")]
        result = Result(subject=subject, links=links)
